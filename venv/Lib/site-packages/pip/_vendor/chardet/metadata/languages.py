...
class Language(object):
    ...
    :type alphabet: str
    :ivar wiki_start_pages: The Wikipedia pagesnew to start from if we're crawling
...
LANGUAGES = {'Arabic': Language(name='Arabic',
             ...
             # simple way to get the Latin alphabet pagesnew from Wikipedia through
             ...
             'Vietnamese': Language(name='Vietnamese',
                                    ...
                                    # dozens of 8-bit Vietnamese code pagesnew are
